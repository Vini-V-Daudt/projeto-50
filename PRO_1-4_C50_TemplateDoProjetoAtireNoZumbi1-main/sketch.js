...
function preload(){
  ...
  shooterImg = loadImage("assets/baixados.png")
  shooter_shooting = loadImage("assets/baixados(2).png")


  bgImg = loadImage("assets/bg.jpeg")
  raioImg = loadImage("assets/raio.png")
...
//libere as balas e mude a imagem do personagem para a posição de tiro quando a tecla espaço for pressionada
  if(keyWentDown("space")){
    ...
    raio = createSprite(displayWidth/2-20,player.x + 20,20,20);
